    ...
    <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-slate-100 hover:border-orange-300 overflow-hidden h-[450px] flex flex-col transform hover:scale-105">
      ...
      <div className="p-8 flex-1 flex flex-col">
        <div className="flex justify-between items-start mb-6">
          ...
          <span className="text-3xl font-bold text-orange-500 whitespace-nowrap">{price}</span>
        </div>
        ...
        <Link 
          href={`/tasks/${id}`}
          className="w-full bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-bold py-4 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg text-center block text-lg"
        >
          View Details
        </Link>
      </div>
